    ...
    <div className="pt-20">
            ...
            >
              ...
              <div className="absolute bottom-10 -left-10 glass-card p-6 rounded-2xl shadow-xl border border-white/50 max-w-[200px]">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-bold text-on-surface">{t('home.hero.uptime')}</span>
                </div>
                <p className="text-[10px] text-on-surface-variant leading-tight">{t('home.hero.verified')}</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-12 bg-surface-container-low">
        <div className="max-w-7xl mx-auto px-8 flex flex-wrap justify-center gap-6">
          {[
            { icon: 'location_on', text: t('home.pills.location') },
            { icon: 'bolt', text: t('home.pills.energy') },
            { icon: 'group', text: t('home.pills.ownership') },
          ].map((pill, i) => (
      ...
      <section className="py-32 px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 max-w-2xl">
            <h2 className="font-headline text-4xl font-bold text-on-surface mb-6">{t('home.features.title')}</h2>
            <p className="text-lg text-on-surface-variant">{t('home.features.description')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-span-8 bg-surface-container-low rounded-[2.5rem] p-12 relative overflow-hidden group">
              <div className="relative z-10">
                ...
                <h3 className="font-headline text-3xl font-bold mb-4">{t('home.features.privacy_title')}</h3>
                <p className="text-lg text-on-surface-variant max-w-md">{t('home.features.privacy_desc')}</p>
              </div>
              <img
            ...
            <div className="md:col-span-4 bg-secondary text-on-secondary rounded-[2.5rem] p-12 flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-headline text-2xl font-bold mb-4">{t('home.features.opensource_title')}</h3>
              </div>
              <p className="text-on-secondary/80">{t('home.features.opensource_desc')}</p>
            </div>
            <div className="md:col-span-4 bg-primary text-on-primary rounded-[2.5rem] p-12 flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-headline text-2xl font-bold mb-4">{t('home.features.local_title')}</h3>
              </div>
              <p className="text-on-primary/80">{t('home.features.local_desc')}</p>
            </div>
            <div className="md:col-span-8 bg-surface-container-highest rounded-[2.5rem] p-12 flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1">
                ...
                <h3 className="font-headline text-2xl font-bold mb-4">{t('home.features.community_title')}</h3>
                <p className="text-on-surface-variant">{t('home.features.community_desc')}</p>
              </div>
      ...
      <section className="py-32 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <h2 className="font-headline text-4xl font-bold text-center mb-24">{t('home.how_it_works.title')}</h2>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 relative">
            ...
            {[
              { id: '01', icon: 'person_add', title: t('home.how_it_works.step1_title'), desc: t('home.how_it_works.step1_desc') },
              { id: '02', icon: 'grid_view', title: t('home.how_it_works.step2_title'), desc: t('home.how_it_works.step2_desc') },
              { id: '03', icon: 'public', title: t('home.how_it_works.step3_title'), desc: t('home.how_it_works.step3_desc') },
            ].map((step) => (
      ...
      <section className="py-32 px-8">
        <div className="max-w-7xl mx-auto bg-primary rounded-[3rem] p-16 md:p-24 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="font-headline text-4xl md:text-6xl font-bold text-on-primary mb-8 tracking-tight">{t('home.cta.title')}</h2>
